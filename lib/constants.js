...
module.exports = {
    ...
    TIMEFRAMES: {
        ...
        'Last 30 Days': { start_date:   -2592000000, end_date: +new Date('4/1/3011')},
        ...
        '2011 Q3':  { start_date: +new Date('6/1/2011'), end_date: +new Date('9/1/2011') },
        '2011 Q4':  { start_date: +new Date('9/1/2011'), end_date: +new Date('1/1/2012') },

        '2012 ':    { start_date: +new Date('1/1/2012'), end_date: +new Date('1/1/2013') },
        '2012 Q1':  { start_date: +new Date('1/1/2012'), end_date: +new Date('3/1/2012') },
        '2012 Q2':  { start_date: +new Date('3/1/2012'), end_date: +new Date('6/1/2012') },
        '2012 Q3':  { start_date: +new Date('6/1/2012'), end_date: +new Date('9/1/2012') },
        '2012 Q4':  { start_date: +new Date('9/1/2012'), end_date: +new Date('1/1/2013') },

        '2013 ':    { start_date: +new Date('1/1/2013'), end_date: +new Date('1/1/2014') },
        '2013 Q1':  { start_date: +new Date('1/1/2013'), end_date: +new Date('3/1/2013') },
        '2013 Q2':  { start_date: +new Date('3/1/2013'), end_date: +new Date('6/1/2013') },
        '2013 Q3':  { start_date: +new Date('6/1/2013'), end_date: +new Date('9/1/2013') },
        '2013 Q4':  { start_date: +new Date('9/1/2013'), end_date: +new Date('1/1/2014') }
    ...
    STATUS_NOTIFY: {
        'New': true,
        'Screened': true,
        'Submitted to Hiring Manager': true,
        'Approved by Hiring Manager': true,
        'Phone Screen': true,
        'Phone Interview': true,
        'Homework/Quiz': true,
        'Review Quiz/Homework': true,
        'Interview': true,
    ...
    STATUS_ORDER: {
        ...
        'Survey':                       {index: status_index++, hide: true, owner: true},
        ...
        'Pending Decision'  :           {index: status_index },
