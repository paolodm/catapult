...
module.exports = {
    ...
    TIMEFRAMES: {
        ...
        '2010 Q1':  { start_date: +new Date('1/1/2010'), end_date: +new Date('4/1/2011') },
        '2010 Q2':  { start_date: +new Date('4/1/2010'), end_date: +new Date('6/1/2011') },
        '2010 Q3':  { start_date: +new Date('6/1/2010'), end_date: +new Date('9/1/2011') },
        '2010 Q4':  { start_date: +new Date('9/1/2010'), end_date: +new Date('9/1/2011') },
        '2011 ':    { start_date: +new Date('1/1/2011'), end_date: +new Date('1/1/2012') },
        '2011 Q1':  { start_date: +new Date('1/1/2011'), end_date: +new Date('4/1/2011') },
        'Past 48 Hours': { start_date: +new Date() -  172800000, end_date: +new Date() },
    ...
    STATUS_ORDER: {
        'Unknown':                      {index: status_index++, hide: true},
        ...
        'Approved':                     {index: status_index++, hide: true},
        ...
        'Rejected':                     {index: status_index++, hide: true},
