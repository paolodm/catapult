...
function employee(req, res, next) {
    res.render('swimlanes.ejs', Data_Access.employee({employee: req.params.employee, session: req.session}));
}

function job(req, res, next) {
    res.render('swimlanes.ejs', Data_Access.job({job: req.params.job}));
}

function team(req, res, next) {
    res.render('swimlanes.ejs', Data_Access.department({department: req.params.team}));
}
...
function addHandlers(options) {
    ...
    Server.dynamicHelpers({
        ...
        in_progress: function() {
            return Data_Access.in_progress;
        },
        last_updated: function() {
            return Data_Access.last_updated;
        }
    });
